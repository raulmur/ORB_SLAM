...
ORB-SLAM is released under a [GPLv3 license](https://github.com/raulmur/ORB_SLAM/blob/master/License-gpl.txt). For a list of all code/library dependencies (and associated licenses), please see [Dependencies.pdf](https://github.com/raulmur/ORB_SLAM/blob/master/Dependencies.pdf).
